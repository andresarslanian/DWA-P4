...
<body>
	<div id="p-header">
		<div id="p-header-wrapper" class="p-clearfix">
			<a href="http://www.philips.com/global/index.page" onclick="return _page.switchHandler('http://www.philips.com/global/index.page', '')"><img alt="Philips" src="http://www.crsc.philips.com/crsc/images/mainlogo.gif" id="p-mainlogo"></a><div id="p-header-utils">
		</div>
	</div>
